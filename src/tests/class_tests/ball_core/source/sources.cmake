...
if(BALL_HAS_XDR)
	list(APPEND tests_core_concept XDRPersistenceManager_test)
endif()

set(tests_core_docking
	IMGDock_test
...
if(BALL_HAS_FFTW)
	list(APPEND tests_core_docking GeometricFit_test)
endif()

set(tests_core_scoring
	CHPI_test
	CHPISlick_test
	MMScoring_test
	PBScoring_test
...
if(BALL_HAS_OPENBABEL)
	list(APPEND tests_core_structure OBinterface_test)
endif()

set(tests_core_solvation
