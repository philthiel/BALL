...
#ifndef BALL_CORE_MOLMEC_MINIMIZATION_CONJUGATEGRADIENT_H 
#define BALL_CORE_MOLMEC_MINIMIZATION_CONJUGATEGRADIENT_H 
...
#endif // BALL_CORE_MOLMEC_MINIMIZATION_CONJUGATEGRADIENT_H 
