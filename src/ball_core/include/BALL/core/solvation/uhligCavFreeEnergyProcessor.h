...
#ifndef BALL_CORE_SOLVATION_UHLIGCAVFREEENERGYPROCESSOR_H
#define BALL_CORE_SOLVATION_UHLIGCAVFREEENERGYPROCESSOR_H
...
#endif // BALL_CORE_SOLVATION_UHLIGCAVFREEENERGYPROCESSOR_H
