...
#ifndef BALL_CORE_SOLVATION_PIEROTTICAVFREEENERGYPROCESSOR_H
#define BALL_CORE_SOLVATION_PIEROTTICAVFREEENERGYPROCESSOR_H
...
#endif // BALL_CORE_SOLVATION_PIEROTTICAVFREEENERGYPROCESSOR_H
