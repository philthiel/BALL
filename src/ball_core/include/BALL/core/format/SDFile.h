...
#ifndef BALL_CORE_FORMAT_SDFILE_H
#define BALL_CORE_FORMAT_SDFILE_H
	...
	*/
		...
		: public MOLFile
	{
		...
		*/
		...
		/**
		 * Count the number of molecule (MOL) records in the SDF
		 *
		 * @return number of MOL records in SDFile
		 */
		Size countMolecules();
...
#endif // BALL_CORE_FORMAT_SDFILE_H
