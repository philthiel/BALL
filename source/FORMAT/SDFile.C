...
namespace BALL 
{
	...
	void SDFile::readPropertyBlock_(Molecule& molecule)
	{
		...
		// Temporary stored member information of LineBasedFile
		// Used to reset the position if necessary
		//streampos current_pos;
		//String current_line;
		//Position current_line_number;

		// Happily much empty lines at the end of a file after the properties block.
