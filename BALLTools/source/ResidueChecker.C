...
int main(int argc, char* argv[])
{
	...
	CommandlineParser parpars("ResidueChecker", "check residues to debug a protein structure wrt to PDB conventions", VersionInfo::getVersion(), String(__DATE__), "ForceFields");
