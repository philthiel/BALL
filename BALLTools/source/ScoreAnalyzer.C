...
int main(int argc, char* argv[])
{
	...
	parpars.registerParameter("s", "score label", STRING, true, "score");
	parpars.registerParameter("e", "binding-free-energy/class label name", STRING, true, "binding_free_energy");
	parpars.registerFlag("b", "binary experimental activity data");
	parpars.registerParameter("t", "only in case of non-binary act. data: binding-free-energy threshold; compound with values *below* this threshold will be defined as binder", STRING);
