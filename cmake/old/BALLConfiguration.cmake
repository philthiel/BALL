...
INCLUDE(old/BALLConfigSList)

## Check for the presence of C++11 initializer lists
INCLUDE(old/BALLConfigInitializerList)

## Check for extern templates
INCLUDE(old/BALLConfigExternTemplates)

## Check for thread_local
INCLUDE(old/BALLConfigThreadLocal)

## Check for rvalue reference
INCLUDE(old/BALLConfigRValueReferences)

## Check for the presence of C++11 noexcept
INCLUDE(old/BALLConfigNoexcept)

## Check for the presence of C++11 features in string
INCLUDE(old/BALLConfigStdStringFeatures)
