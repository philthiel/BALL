...
///////////////////////////
#include <BALL_core/VIEW/KERNEL/representationManager.h>
#include <BALL_core/VIEW/KERNEL/mainControl.h>
#include <BALL_core/VIEW/KERNEL/clippingPlane.h>
#include <BALL_core/VIEW/DIALOGS/displayProperties.h>
