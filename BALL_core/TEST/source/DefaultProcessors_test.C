...
CHECK(AssignRadiusProcessor::setFilename(const String& filename))
	...
	arp.setFilename(BALL_TEST_DATA_PATH(amber91.ini));
RESULT


CHECK(AssignRadiusProcessor::getFilename())
	TEST_EQUAL(arp.getFilename(), BALL_TEST_DATA_PATH(amber91.ini));
RESULT
...
CHECK(AssignChargeProcessor::setFilename(const String& filename))
	...
	acp.setFilename(BALL_TEST_DATA_PATH(amber91.ini));
RESULT


CHECK(AssignRadiusProcessor::getFilename())
	TEST_EQUAL(acp.getFilename(), BALL_TEST_DATA_PATH(amber91.ini));
RESULT
